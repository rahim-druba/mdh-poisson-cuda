...
#ifndef MDH_CUDA_INPUT_BUFFER_WRAPPER_HPP
#define MDH_CUDA_INPUT_BUFFER_WRAPPER_HPP
...
class cuda_input_buffer_wrapper : public input_wrapper {
public:
    cuda_input_buffer_wrapper(const input_buffer_class &input_buffer, const macros <L_DIMS, R_DIMS> &macros)
...
#endif //MDH_CUDA_INPUT_BUFFER_WRAPPER_HPP
